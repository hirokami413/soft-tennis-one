...
export const LoginView: React.FC = () => {
  ...
  const handleSocialClick = async (provider: 'google' | 'apple' | 'line') => {
    try {
      setIsLoggingIn(true);
        ...
        <div className="text-center mb-8">
          ...
          <div className="bg-white rounded-3xl shadow-lg border border-slate-100 p-8 space-y-5 animate-in fade-in duration-300">
            ...
            <button
              ...
              disabled={isLoggingIn}
              className="w-full flex items-center gap-3 px-5 py-3.5 rounded-2xl hover:opacity-90 transition-all active:scale-[0.98] shadow-sm disabled:opacity-50"
