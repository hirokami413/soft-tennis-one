    ...
    <div className="flex flex-col gap-6 py-2">
      ...
      <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm">
        ...
        <div className="text-slate-600 text-sm leading-relaxed space-y-4">
          <p>
            せっかくコートに立ったのに、メニューが決まらず、目的もなく乱打だけして時間が過ぎていく。そんな経験が僕にもあります。「今の人数や時間にぴったりの練習を、現場で即座に引き出せるツール」を作ること——このプロジェクトはそこから始まりました。
          </p>
          <p className="font-semibold text-slate-700 bg-blue-50 p-4 rounded-2xl border border-blue-100">
            「メニューを検索して終わり」ではなく、練習を振り返り、プロから学び、一人ひとりが確実に成長できる環境を作りたい。
          </p>
          <p>
            その想いから、『ソフトテニス One』は単なるメニュー集にとどまらず、AIが練習の組み立てをサポートする提案機能、日々の気づきを記録する「テニスノート」、そしてプロコーチに直接相談できる「コーチ相談」機能を備えた練習支援プラットフォームへと進化しました。
          </p>
          <p>
            ここは僕たちが一方的に教えるだけの場所ではありません。ユーザーの皆さんが練習メニューを投稿し、「やってみた」レポートを共有し、みんなで「最高の練習」をストックしていく場所です。
          </p>
        </div>
